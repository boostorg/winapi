...
BOOST_SYMBOL_IMPORT boost::winapi::VOID_ BOOST_WINAPI_DETAIL_WINAPI_CC Sleep(boost::winapi::DWORD_ dwMilliseconds);
BOOST_SYMBOL_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_DETAIL_WINAPI_CC SwitchToThread(BOOST_WINAPI_DETAIL_VOID);
} // extern "C"
#endif
