...
#if defined(WINAPI)
#define BOOST_WINAPI_DETAIL_WINAPI_CC WINAPI
#else
#define BOOST_WINAPI_DETAIL_WINAPI_CC BOOST_WINAPI_DETAIL_STDCALL
#endif

#if defined(CALLBACK)
#define BOOST_WINAPI_DETAIL_CALLBACK_CC CALLBACK
#else
#define BOOST_WINAPI_DETAIL_CALLBACK_CC BOOST_WINAPI_DETAIL_STDCALL
#endif

#if defined(NTAPI)
#define BOOST_WINAPI_DETAIL_NTAPI_CC NTAPI
#else
#define BOOST_WINAPI_DETAIL_NTAPI_CC BOOST_WINAPI_DETAIL_STDCALL
#endif
