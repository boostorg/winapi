...
#if !defined( BOOST_NO_ANSI_APIS )
BOOST_SYMBOL_IMPORT boost::winapi::DWORD_PTR_ BOOST_WINAPI_DETAIL_WINAPI_CC SHGetFileInfoA(
...
BOOST_SYMBOL_IMPORT boost::winapi::DWORD_PTR_ BOOST_WINAPI_DETAIL_WINAPI_CC SHGetFileInfoW(
