...
extern "C" {
BOOST_SYMBOL_IMPORT boost::winapi::HLOCAL_ BOOST_WINAPI_DETAIL_WINAPI_CC
LocalAlloc(
...
BOOST_SYMBOL_IMPORT boost::winapi::HLOCAL_ BOOST_WINAPI_DETAIL_WINAPI_CC LocalFree(boost::winapi::HLOCAL_ hMem);
} // extern "C"
#endif
