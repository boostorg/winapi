...
BOOST_CONSTEXPR_OR_CONST HANDLE_ INVALID_HANDLE_VALUE_ = INVALID_HANDLE_VALUE;
#else
BOOST_CONSTEXPR_OR_CONST DWORD_ DUPLICATE_CLOSE_SOURCE_ = 1;
BOOST_CONSTEXPR_OR_CONST DWORD_ DUPLICATE_SAME_ACCESS_ = 2;
BOOST_CONSTEXPR_OR_CONST HANDLE_ INVALID_HANDLE_VALUE_ = (HANDLE_)(-1);
#endif
...
BOOST_CONSTEXPR_OR_CONST HANDLE_ invalid_handle_value = INVALID_HANDLE_VALUE_;
