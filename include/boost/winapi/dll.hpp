...
#ifdef _WIN64
typedef INT_PTR_ (BOOST_WINAPI_DETAIL_WINAPI_CC *FARPROC_)();
typedef INT_PTR_ (BOOST_WINAPI_DETAIL_WINAPI_CC *NEARPROC_)();
typedef INT_PTR_ (BOOST_WINAPI_DETAIL_WINAPI_CC *PROC_)();
#else
typedef int (BOOST_WINAPI_DETAIL_WINAPI_CC *FARPROC_)();
typedef int (BOOST_WINAPI_DETAIL_WINAPI_CC *NEARPROC_)();
typedef int (BOOST_WINAPI_DETAIL_WINAPI_CC *PROC_)();
#endif // _WIN64
}} // namespace boost::winapi

#if !defined( BOOST_NO_ANSI_APIS )
BOOST_SYMBOL_IMPORT boost::winapi::HMODULE_ BOOST_WINAPI_DETAIL_WINAPI_CC
...
#if !defined( UNDER_CE )
BOOST_SYMBOL_IMPORT boost::winapi::FARPROC_ BOOST_WINAPI_DETAIL_WINAPI_CC
...
BOOST_SYMBOL_IMPORT boost::winapi::SIZE_T_ BOOST_WINAPI_DETAIL_WINAPI_CC
VirtualQuery(
