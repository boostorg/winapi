...
BOOST_SYMBOL_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_DETAIL_WINAPI_CC CreateJobObjectA(
...
BOOST_SYMBOL_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_DETAIL_WINAPI_CC CreateJobObjectW(
    ::_SECURITY_ATTRIBUTES* lpJobAttributes,
    boost::winapi::LPCWSTR_ lpName);

BOOST_SYMBOL_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_DETAIL_WINAPI_CC AssignProcessToJobObject(
    boost::winapi::HANDLE_ hJob,
    boost::winapi::HANDLE_ hProcess);

#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WINXP
BOOST_SYMBOL_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_DETAIL_WINAPI_CC IsProcessInJob(
    boost::winapi::HANDLE_ ProcessHandle,
    boost::winapi::HANDLE_ JobHandle,
    boost::winapi::PBOOL_ Result);
#endif

BOOST_SYMBOL_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_DETAIL_WINAPI_CC TerminateJobObject(
    boost::winapi::HANDLE_ hJob,
...
#if !defined( BOOST_NO_ANSI_APIS )
#if BOOST_WINAPI_PARTITION_DESKTOP
BOOST_SYMBOL_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_DETAIL_WINAPI_CC OpenJobObjectA(
...
#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_SYMBOL_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_DETAIL_WINAPI_CC OpenJobObjectW(
    boost::winapi::DWORD_ dwDesiredAccess,
    boost::winapi::BOOL_ bInheritHandles,
    boost::winapi::LPCWSTR_ lpName);
#endif
