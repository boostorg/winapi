...
#define BOOST_WINAPI_PARTITION_APP           (!BOOST_PLAT_WINDOWS_UWP || BOOST_PLAT_WINDOWS_DESKTOP || BOOST_PLAT_WINDOWS_STORE || BOOST_WINAPI_PARTITION_PHONE)
#define BOOST_WINAPI_PARTITION_PC            (!BOOST_PLAT_WINDOWS_UWP || BOOST_PLAT_WINDOWS_STORE)
#define BOOST_WINAPI_PARTITION_PHONE         (!BOOST_PLAT_WINDOWS_UWP || BOOST_PLAT_WINDOWS_PHONE)
#define BOOST_WINAPI_PARTITION_SYSTEM        (!BOOST_PLAT_WINDOWS_UWP || BOOST_PLAT_WINDOWS_SYSTEM)
#define BOOST_WINAPI_PARTITION_SERVER        (!BOOST_PLAT_WINDOWS_UWP || BOOST_PLAT_WINDOWS_SERVER)
#define BOOST_WINAPI_PARTITION_DESKTOP       (!BOOST_PLAT_WINDOWS_UWP || BOOST_PLAT_WINDOWS_DESKTOP)
